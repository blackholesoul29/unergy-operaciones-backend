...
# NOTA: el DDL idempotente que antes se ejecutaba al arranque (lista
# _PENDING_DDLS + _run_column_migrations) se movió a migraciones de Alembic
# (alembic/versions/026_consolidar_pending_ddls_main.py). El esquema ahora
# evoluciona solo vía `alembic upgrade head`; la app no modifica DDL en runtime.

...
# NOTE: schema DDL (CREATE TABLE / ALTER TABLE / CREATE TYPE / ADD VALUE) used to run
# here on every boot. It now lives in the Alembic baseline migration
# alembic/versions/000_baseline_initial_schema.py. Alembic is the sole source of
# truth for the schema; the app assumes the schema already exists at startup.

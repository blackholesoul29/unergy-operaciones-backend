...
_PENDING_DDLS = [
    ...
    # migration 009 — tarifas de servicios por inversionista
    "ALTER TABLE proyecto_inversionistas ADD COLUMN IF NOT EXISTS tarifa_administracion NUMERIC(5,2)",
    "ALTER TABLE proyecto_inversionistas ADD COLUMN IF NOT EXISTS tarifa_cgm NUMERIC(5,2)",
    "ALTER TABLE proyecto_inversionistas ADD COLUMN IF NOT EXISTS tarifa_representacion NUMERIC(5,2)",
]

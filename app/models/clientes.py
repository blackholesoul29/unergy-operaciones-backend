...
from sqlalchemy import BigInteger, String, Numeric, Enum as SAEnum, DateTime, Date, ForeignKey, Text, text
...
class Cliente(Base):
    ...
    correos_operacionales: Mapped[list | None] = mapped_column(JSONB, nullable=True, default=list, server_default=text("'[]'::jsonb"))

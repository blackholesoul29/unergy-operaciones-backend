...
class Cliente(Base):
    ...
    correos_operacionales: Mapped[list | None] = mapped_column(JSONB, nullable=True, default=list, server_default="[]")
    correos_cgm: Mapped[list | None] = mapped_column(JSONB, nullable=True, default=list, server_default="[]")

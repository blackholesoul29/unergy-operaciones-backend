...
PROYECTOS_RAW = [
    ...
    {"topic_slug": "bayunca",            "nombre_comercial": "Bayunca",                               "potencia_instalada_kwp": 3000, "cantidad_total_paneles": None,  "produccion_especifica_kwh_kwp": None, "cliente_nombre": "PARQUE EOLICO DE GALERAZAMBA S.A.S.", "tipo_tecnologia": "eolica"},

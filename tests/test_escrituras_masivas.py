...
INVENTARIO_CONOCIDO: dict[tuple[str, str], tuple[int, str]] = {
    ...
    # El motor MGS ya no escribe en `fallas`: la creación/cierre automático se
    # eliminó (2026-09-02, decisión de Laura -- las fallas se registran solo a
    # mano o por el integrador externo). Antes vivía acá el UPDATE de
    # codigo_interno que hacía _auto_create_fallas tras su INSERT.
}

...
_CAMPOS_ESPERADOS = {
    ...
    "clientes_cgm", "codigo_frontera",
    "codigo_sic_submercado_consumo",
    "codigo_sic_submercado_exportador", "created_at",
    "entidad_calibradora_med_ppal", "entidad_calibradora_med_resp",
    "estado",
    "fecha_actualizacion_ppal", "fecha_actualizacion_resp",
    ...
    "nro_serie_med_ppal", "nro_serie_med_resp",
    "num_elementos_med_ppal", "num_elementos_med_resp", "operador_comercial",
    "operador_correos", "operador_red_id",

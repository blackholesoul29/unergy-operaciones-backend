...
_CAMPOS_ESPERADOS = {
    ...
    "nivel_tension", "nivel_tension_kv", "nombre_cgm", "nombre_frontera",
    ...
    "punto_conexion", "quoia_border_id", "registrada_por",
    "representante_anterior", "representante_frontera", "subestacion",

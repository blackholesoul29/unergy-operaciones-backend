...
TABLA_JUNIO_2026 = [
    ...
    ("La Mesa",            "2024-08-23", "2025-11-19", 48_000_000, 4_204_000),
    ...
    ("San Diego Sur",      "2025-10-20", "2023-10-30", 54_000_000, 4_729_500),
...
def test_la_paz_vallenata_usa_firma_dos_ipcs():
    # firma(2024) > om(2023) → usa firma → IPCs 2025+2026
    f = _calc(firma="2024-08-23", om="2023-09-01", base=48_000_000)
...
def test_san_diego_sur_sigue_la_regla():
    ...
    f = _calc(firma="2025-10-20", om="2023-10-30", base=54_000_000)
    assert f["n_indexaciones"] == 1
...
def test_la_reserva_usa_firma_un_ipc():
    ...
    f = _calc(firma="2025-05-10", om="2025-04-16", base=36_880_000)
    assert f["n_indexaciones"] == 1
